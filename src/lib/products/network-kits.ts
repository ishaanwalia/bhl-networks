...
export const network_kits_products: Product[] = [
  {
    ...
    shortSpecs: ["Bundle", "Multi-product"],
    features: [
      "Curated bundle with all essential components for quick installation",
      "Pre-calculated quantities eliminate guesswork and waste",
      "Significant cost savings compared to individual purchases",
      "Color-matched components for professional appearance",
      "Includes cable management accessories for clean installations",
      "Ideal for contractors, installers, and DIY network projects"
    ],
    specifications: {
      "Type": "Installation Bundle",
      "Components": "Multiple (see in-box)",
      "Savings": "Up to ₹1,500",
      "Warranty": "1 Year",
      "Ideal For": "Contractors, installers, DIY"
    },
    useCases: [
    ...
    inBox: [
      "See product description for complete component list",
      "All items pre-packed in branded BHL box",
      "Installation guide",
      "Warranty card"
    ],
    warranty: "1 Year BHL Networks Warranty",
    images: ["/products/network-kits/bhl-basic-network-kit.jpg"],
  },
  {
    id: 165,
    ...
    warranty: "1 Year BHL Networks Warranty",
    images: ["/products/network-kits/bhl-office-network-kit.jpg"],
  },
  {
    id: 166,
    ...
    warranty: "1 Year BHL Networks Warranty",
    images: ["/products/network-kits/bhl-ftth-starter-kit.jpg"],
  },
  {
    id: 167,
    ...
    warranty: "1 Year BHL Networks Warranty",
    images: ["/products/network-kits/bhl-cctv-power-kit.jpg"],
  },
  {
    id: 168,
    ...
    warranty: "1 Year BHL Networks Warranty",
    images: ["/products/network-kits/bhl-data-center-kit.jpg"],
  },
  {
    id: 169,
    ...
    warranty: "1 Year BHL Networks Warranty",
    images: ["/products/network-kits/bhl-sfp-combo-kit.jpg"],
  },
  {
    id: 170,
    ...
    warranty: "1 Year BHL Networks Warranty",
    images: ["/products/network-kits/bhl-structured-cabling-kit.jpg"],
  }
];

export default network_kits_products;